...
@ConfigurationParameter(key = PLUGIN_PROPERTY_NAME, 
    value = "pretty, html:tmp/reports/cucumber-report.html, json:tmp/reports/cucumber.json")
...
public class CucumberPlaywrightRunner {
    // Runner implementation remains empty
}